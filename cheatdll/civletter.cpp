...
SET_HOOK_ASSIGN civLetterHooks [] =
{
	{(void*)0x0053A874, &altLetter1},
	{(void*)0x0053A93B, &altLetter2},
	{(void*)0x0053A9EE, &altLetter3},
	{(void*)0x0053AA46, &altLetter4}
};
...
#endif
	for (int i = 0; i < (sizeof(civLetterHooks)/sizeof(civLetterHooks[0])); i++)
		setHook (civLetterHooks[i].addr, civLetterHooks[i].newAddr);
}
