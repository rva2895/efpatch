...
struct prop_object
{
    ...
    float       unknown3A;
    char        resource_1_store_mode;
    char        resource_2_store_mode;
    char        resource_3_store_mode;
    ...
    char        hero_mode;
    //type80+
    int         garrison_graphics;
    int         unk1C8;
    int         unk1CC;
    int         unk1D0;
    char        adjacent_mode;
    short       graphics_angle;
    char        disappears_when_built;
    short       stack_unit_id;
    short       foundation_terrain_id;
    short       old_terrain_like_id;
    short       research_id;
    int         unk1E4;
    int         unk1E8;
    int         unk1EC;
