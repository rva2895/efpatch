...
void setCoreHooks()
{
    ...
    */
    ...
    //
    //is_gate_openable
    static const BYTE is_gate_openable_patch[] = { 0x8B, 0x41, 0x14, 0x56, 0x66, 0x83, 0x78, 0x1E, 0x08, 0x75, 0x51, 0x8B, 0xF1, 0x57 };
    writeData(0x005582F0, is_gate_openable_patch, sizeof(is_gate_openable_patch));
    //capture_frame_3d_square
    writeNops(0x0054CE9A, 8);
    writeNops(0x0054CEA5, 3);
    //get_node
    writeNops(0x00547547, 3);
    //decode_mp3_data
    ...
    writeNops(0x004BD8F5, 5);
    writeNops(0x004BD8D4, 2);
    ...
    //add_path_node
    static const BYTE add_path_node_patch[] = { 0x8B, 0x5D, 0x1C, 0x8B, 0x0C, 0xB8, 0x8B, 0x45, 0x10, 0x8B, 0x0C, 0x91, 0x8D, 0x0C, 0x41, 0x89, 0x4D, 0xF4, 0x8A, 0x09, 0xEB, 0x20 };
    ...
    //delete_dynamic_tile
    static const BYTE delete_dynamic_tile_patch[] = { 0x39, 0x38, 0x74, 0x14, 0x8B, 0xF0, 0x8B, 0x40, 0x04, 0xEB, 0xF5 };
